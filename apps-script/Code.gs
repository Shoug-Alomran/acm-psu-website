...
var CANONICAL_SHEETS = {
  'People': ['Name', 'PSU Email', 'Person Type', 'University Role', 'ACM Role', 'Project Roles', 'Registration Date', 'Registration Semester', 'Account State', 'Admin/System Roles', 'Student ID', 'Major', 'Academic Year', 'Membership Status'],
  'Membership Applications': ['Application ID', 'Applicant Name', 'Student ID', 'PSU Email', 'Major', 'Academic Year', 'Interests', 'Goal', 'Status', 'Chapter Year', 'Reviewed By', 'Reviewed At', 'Decision Note', 'Internal Note', 'Approved Position', 'Membership Start Date', 'Registration Date', 'Registration Semester', 'Academic Calendar', 'Updated At'],
  'Members': ['Name', 'PSU Email', 'Student ID', 'Major', 'Academic Year', 'Membership Status', 'Registration Date', 'Registration Semester', 'Membership Start', 'Membership End', 'Member Number', 'Chapter Year', 'Club Position', 'Account State'],
